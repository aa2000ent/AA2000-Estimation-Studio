...
// Fixed brand color — no longer shifts based on the typed username,
// since role is resolved after authentication, not guessed at while typing.
const BRAND = {
  primary: "#1E3A8A",
  accent: "#2563EB",
...
export default function Login({ onLogin }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Credentials are checked only on submit — no live preview of who
    // a username belongs to before the PIN is verified.
